...
This repo is for ST558 Project2. We are trying to use [online new popularity date set](https://archive.ics.uci.edu/ml/datasets/Online+News+Popularity) to visualize data, fit four models, and comparing them for six different data channels. 
...
The analysis for [Business articles is available here](BusiessAnalysis.html).  

The analysis for [Social Media articles is available here](SocialMediaAnalysis.html).  
